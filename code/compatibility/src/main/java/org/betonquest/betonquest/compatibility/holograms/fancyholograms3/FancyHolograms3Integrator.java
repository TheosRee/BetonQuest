 ...
 */
public class FancyHolograms3Integrator implements HologramIntegration {

    /**
     * The minimum required version of FancyHolograms.
     */
    public static final String REQUIRED_VERSION = "3.0.0-SNAPSHOT";
     ...
     */
    public FancyHolograms3Integrator() {
    }
    ...
    public static Policy[] getPolicies() {
        return Policies.pluginVersionRange(NAME,
                ...
                VersionParser.parse(DefaultVersionType.SIMPLE_SEMANTIC_VERSION, "3.999"));
    }
