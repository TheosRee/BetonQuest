 ...
 */
public class CustomClickSlowTellrawConvIO extends CustomClickTellrawConvIO {
     ...
     */
    public CustomClickSlowTellrawConvIO(final Plugin plugin, final Conversation conv, final OnlineProfile onlineProfile,
    ...
    public void end(final Runnable callback) {
        if (canReply) {
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    if (canReply) {
                        CustomClickSlowTellrawConvIO.super.end(callback);
                        this.cancel();
                    }
                }
