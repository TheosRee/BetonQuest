 ...
 */
public class CustomClickSlowTellrawConvIOFactory implements ConversationIOFactory {
     ...
     */
    public CustomClickSlowTellrawConvIOFactory(final FontRegistry fontRegistry, final ConversationColors colors) {
    ...
    public ConversationIO parse(final Conversation conversation, final OnlineProfile onlineProfile) {
        ...
        return new CustomClickSlowTellrawConvIO(betonQuest, conversation, onlineProfile, messageDelay, componentLineWrapper, colors);
    }
}
