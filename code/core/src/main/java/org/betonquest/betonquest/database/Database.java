...
public abstract class Database {
    ...
    /**
     * If the database should not accept new operations.
     */
     ...
     * @throws SQLException when the database is not initialized or the connection could not be opened
     */
    ...
    /**
     * Sets if the database should not accept new operations.
     *
     * @param shuttingDown true if new operations should be denied
     */
