...
public class BetonQuestItem implements QuestItem {
     ...
     * @param handlers the populated handlers defining the QuestItem
     ...
     * @deprecated in favor of {@link ItemProcessor#itemToString(ItemStack)}
     */
    @Deprecated
    public static String itemToString(final ItemStack item) {
        return ItemProcessor.itemToString(item);
    }
