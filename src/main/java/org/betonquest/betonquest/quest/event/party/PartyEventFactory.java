...
public class PartyEventFactory implements EventFactory {
    ...
    public Event parseEvent(final Instruction instruction) throws InstructionParseException {
        ...
        final ConditionID[] conditions = instruction.getArray(string -> instruction.getID(ConditionID::new));
        final EventID[] events = instruction.getArray(string -> instruction.getID(EventID::new));
