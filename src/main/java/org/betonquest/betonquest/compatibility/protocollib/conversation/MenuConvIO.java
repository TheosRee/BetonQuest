...
public abstract class MenuConvIO extends ChatConvIO {
    /**
    ...
    @SuppressWarnings({"deprecation", "PMD.EmptyMethodInAbstractClassShouldBeAbstract"})
    @Override
    ...
    protected void passPlayerAnswer() {
    ...
    protected void updateDisplay(final Scroll scroll) {
        if (chatDisplay == null) {
