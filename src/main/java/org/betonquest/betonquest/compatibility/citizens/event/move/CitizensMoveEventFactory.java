...
public class CitizensMoveEventFactory implements EventFactory {
    ...
    public Event parseEvent(final Instruction instruction) throws InstructionParseException {
        ...
        final EventID[] doneEvents = instruction.getArray(instruction.getOptional("done"), string -> instruction.getID(EventID::new));
        final EventID[] failEvents = instruction.getArray(instruction.getOptional("fail"), string -> instruction.getID(EventID::new));
