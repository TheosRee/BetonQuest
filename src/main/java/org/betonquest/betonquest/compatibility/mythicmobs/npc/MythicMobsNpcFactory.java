...
public class MythicMobsNpcFactory implements NpcFactory<ActiveMob> {
    ...
    private enum Type {
        ...
        BY_MYTHIC_MOB {
            @Override
            protected NpcWrapper<ActiveMob> parse(final Instruction instruction, final MobExecutor mobExecutor) throws InstructionParseException {
         ...
         * @throws InstructionParseException if the instruction cannot be parsed or there is no valid target for it
         */
        protected abstract NpcWrapper<ActiveMob> parse(Instruction instruction, MobExecutor mobExecutor) throws InstructionParseException;
