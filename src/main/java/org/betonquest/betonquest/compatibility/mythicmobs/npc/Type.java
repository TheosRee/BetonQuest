...
enum Type {
     ...
     */
    record UUIDWrapper(UUID uuid, MobExecutor mobExecutor) implements NpcWrapper<ActiveMob> {
        @Override
     ...
     * @param mobExecutor the instance to get the mob from
     */
    record TypeWrapper(MythicMob type, MobExecutor mobExecutor) implements NpcWrapper<ActiveMob> {
        @Override
        public Npc<ActiveMob> getNpc() throws QuestException {
