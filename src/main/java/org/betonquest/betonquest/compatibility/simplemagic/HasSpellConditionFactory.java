...
public class HasSpellConditionFactory implements PlayerConditionFactory {
    private final SimpleMagicService simpleMagic;

    public HasSpellConditionFactory(final SimpleMagicService simpleMagic) {
    ...
    public PlayerCondition parsePlayer(final Instruction instruction) throws QuestException {
        ...
        return new OnlineConditionAdapter(new HasSpellCondition(simpleMagic, count), profile -> {
