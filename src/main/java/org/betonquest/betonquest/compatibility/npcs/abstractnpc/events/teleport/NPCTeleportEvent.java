package org.betonquest.betonquest.compatibility.npcs.abstractnpc.events.teleport;
...
public class NPCTeleportEvent implements ComposedEvent {
     ...
     */
    public NPCTeleportEvent(final String npcId, final Supplier<BQNPCAdapter> npcSupplier, final CompoundLocation location) {
        this.npcId = npcId;
    ...
    public void execute(@Nullable final Profile profile) throws QuestRuntimeException {
        NPCUtil.getNPC(npcSupplier, npcId).teleport(location.getLocation(profile));
    }
}
