...
public class VariableIDTheOther<T extends ID> extends Variable<T> {
     ...
     */
    public VariableIDTheOther(final VariableProcessor variableProcessor, final QuestPackage pack, final String input, final IDArgument<T> argument) throws InstructionParseException {
