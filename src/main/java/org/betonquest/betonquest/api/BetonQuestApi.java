...
public interface BetonQuestApi {
    ...
    /**
     * Gets the core QuestTypeRegistries to add new core implementations.
     *
     * @return registry for core types
     */
    ...
    /**
     * Gets the FeatureRegistries to add new feature implementations.
     *
     * @return registry for feature types
     */
